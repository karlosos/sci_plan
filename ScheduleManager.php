                ...
                if ($schedule->find('tr', $hour_index)) {
                    ...
                    if ($td->find('span', 0)) {
                        ...
                        if ($td->find('span', 0)->find('span', 0)) {
                            $subject = $td->find('span', 0)->find('span', 0)->plaintext.' dzielony';
                            ...
                            $test_anchor = 1;
                            if ($td->find('span', 2)) {
                                $subject = $td->find('span', 2)->find('span', 0)->plaintext;
                                $teacher = $td->find('span', 2)->find('a', 0)->href;
                                if ($td->find('span', 2)->find('a', 1)) {
                                    $sala = $td->find('span', 2)->find('a', 1)->href;
                                }
                                $teacher = substr($teacher, 0, strlen($teacher) - 5);
                                $sala = substr($sala, 0, strlen($sala) - 5);
                                $teacher = substr($teacher, 1);
